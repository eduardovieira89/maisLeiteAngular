...
export const REPRODUCAO_ROUTES: Routes = [
  { path: '', redirectTo: 'reproducao', pathMatch: 'full' },
  { path: 'reproducao', component: Reproducao},
  ...
  { path: 'semens', loadChildren: () => import('./semen/semen.routes').then(s => s.SEMEN_ROUTES), canActivate:[canActivateGuard]},
]
